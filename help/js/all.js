...
DR_EXPLAIN.data_menu = {
	// menu
	DREX_NODE_NAMES: ["The Sorter","О программе","Работа с программой","Системные требования","О разработчике","Выбор файла для конвертации","Отображение гистограммы","Сортировка вставками","Быстрая сортировка"],
	DREX_NODE_LINKS: ["the_sorter.htm","o_programme.htm","rabota_s_programmoj.htm","sistemnye_trebovaniya.htm","o_razrabotchike.htm","vybor_fajla_dlya_konvertatsii.htm","otobrazhenie_gistogrammy.htm","sortirovka_vstavkami.htm","bystraya_sortirovka.htm"],
	DREX_NODE_CHILD_START: [1,5,5,9,9,9,9,9,9],
	DREX_NODE_CHILD_END: [5,5,9,9,9,9,9,9,9],
	DREX_MENU_TYPE: 1,
